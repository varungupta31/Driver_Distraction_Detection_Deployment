def get_image(imagePath,imageName):
    ...
    try:
        ...
        flags.DEFINE_string('output', './static/detections/', 'path to output folder')
    ...
    def detect(_argv):
        ...
        for count, image_path in enumerate(images, 1):
            ...
            cv2.imwrite(FLAGS.output + imageName, image)
...
get_image('./data/images/phone.jpg','phone.jpg')
